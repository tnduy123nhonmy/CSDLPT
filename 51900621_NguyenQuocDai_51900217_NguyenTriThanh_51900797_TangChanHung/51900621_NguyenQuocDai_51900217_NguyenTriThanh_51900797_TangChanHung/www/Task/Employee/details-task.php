...
<body>
	...
	<div class="container">
        ...
        <div class="mb-3">
        <?php if($idStatus == 2 || $idStatus == 4){ //Mở if: Nếu idStatus là 2 (in progress) hoặc 3 (rejected) thì sẽ show ra ?>
			<a href="./submitTask.php?idTask=<?=  $idTask; ?>" class="btn btn-success px-3">Submit</a>
		<?php } // đóng if?>
        <?php if($idStatus == 1){ //Mở if: Nếu idStatus là 1 (New) thì sẽ show ra ?>
						<a href="./startTask.php?idTask=<?=  $idTask; ?>" class="btn btn-primary"><i class=""></i>Start</a>
		<?php } // đóng if?>
