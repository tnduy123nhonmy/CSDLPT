...
<body>
	...
	<div class="container">
            ...
            <dl class="dl-horizontal">
                ...
                <?php if(!($fileDayOff == "$idDayOff-")){?>
                    ...
                    <dd class="mr-4"><?= $fileDayOff ?></dd>
                        <dd><a class="btn btn-primary" href="download-file-dayoff.php?id=<?= $idDayOff ?>"><i class="fas fa-download"></i></a></dd>
                    </div>
                <?php }?>
            </dl>
       ...
       <div>
            <?php if($idStatus == 1){ //Mở if: Nếu idStatus là 1 (waiting) thì sẽ show ra ?>
                <a href="./approve-nghiphep.php?id=<?=  $idDayOff; ?>" class="btn btn-success"><i class=""></i>Approve</a>
                <a href="./refuse-nghiphep.php?id=<?=  $idDayOff; ?>" class="btn btn-danger"><i class=""></i>Refuse</a>
            <?php } // đóng if?>
                <a href="./list-nghiphep.php" class="btn btn-secondary px-3" >Quay lại</a>
       </div>
	</div>
