...
<body>
	...
	<div class="container">
		<header class="text-center bg-light text-info py-3 rounded">
			<h3 class="display-5 font-weight-bold mb-1 ">LỊCH SỬ ĐƠN NGHỈ PHÉP</h3>
		</header>
		...
		<?php
            ...
            $rolePerson = 2;
			$conn = connect_db();
			$sql = "SELECT * from dayOff where idPerson=? ORDER BY dayApplyOff DESC, idStatus ASC ";
			$stm = $conn->prepare($sql);
		...
		<tr>
			...
			<td class="text-center">
				<a href="<?php echo 'detailsMyself-nghiphep.php?id='.$idDayOff; ?>" class="btn btn-primary"><i class="fas fa-list"></i></a>
